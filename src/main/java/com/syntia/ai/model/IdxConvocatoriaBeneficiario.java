...
@Entity
@Table(name = "idx_convocatoria_beneficiario",
       uniqueConstraints = @UniqueConstraint(columnNames = {"numero_convocatoria", "beneficiario_id"}))
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class IdxConvocatoriaBeneficiario {
    @Id
