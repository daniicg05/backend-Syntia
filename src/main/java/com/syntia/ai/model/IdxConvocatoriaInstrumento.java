...
@Entity
@Table(name = "idx_convocatoria_instrumento",
       uniqueConstraints = @UniqueConstraint(columnNames = {"numero_convocatoria", "instrumento_id"}))
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class IdxConvocatoriaInstrumento {
    @Id
